...
public class BluetoothService {
    ...
    // context : The xyz.pengzhihui.clover.UI Activity Context
    // handler : A Handler to send messages back to the xyz.pengzhihui.clover.UI Activity
    ...
    private synchronized void setState(int state) {
        ...
        // Give the new state to the Handler so the xyz.pengzhihui.clover.UI Activity can update
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice
        ...
        // Send the name of the connected device back to the xyz.pengzhihui.clover.UI Activity
    ...
    // Indicate that the connection attempt failed and notify the xyz.pengzhihui.clover.UI Activity
    private void connectionFailed() {
        // Start the service over to restart listening mode
        BluetoothService.this.start(BluetoothService.this.isAndroid);
    }

    // Indicate that the connection was lost and notify the xyz.pengzhihui.clover.UI Activity
    ...
    private class ConnectedThread extends Thread {
            ...
            while (true) {
                try {
                    ...
                    if(data == 0x0A) { 
                        ...
                        // Send the obtained bytes to the xyz.pengzhihui.clover.UI Activity
        ...
        public void write(byte[] buffer) {
            try {/*
                ...
                // Share the sent message back to the xyz.pengzhihui.clover.UI Activity
